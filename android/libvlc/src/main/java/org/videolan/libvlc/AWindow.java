...
public class AWindow implements IVLCVout {
    ...
    @Override
    public void attachSurfaceSlave(Surface videoSurface, Surface subtitlesSurface, OnNewVideoLayoutListener mOnNewVideoLayoutListener) {
        setNativeSurface(ID_VIDEO, videoSurface);
        setNativeSurface(ID_SUBTITLES, subtitlesSurface);
        attachViews(mOnNewVideoLayoutListener);
        surfaceReady();
    }
